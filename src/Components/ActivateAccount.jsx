...
const ActivateAccount = () => {
    ...
    useEffect(() => {
        const activateAccount = async () => {
            ...
            try {
                ...
                const response = await axios.get(`https://url-shortener-application-be.onrender.com/user/activate/${token}`);
    ...
    return (
        <div className="container activation-msg py-5" style={{ border: '2px solid black' }}>
                            ...
                            <div className='col-sm-10 col-md-8 col-lg-8 col-xl-8'>
                                ...
                                {message.includes('successfully') ? (
                                    <div className='d-flex justify-content-center mt-3'>
                                        <Link to='/login'>
                                            <button className='btn btn-outline-primary'>Back to Login</button>
                                        </Link>
                                    </div>
                                ) : (
                                    <div className='d-flex justify-content-center mt-3'>
